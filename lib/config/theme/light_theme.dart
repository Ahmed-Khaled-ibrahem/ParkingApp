...
ThemeData lightTheme = ThemeData(
  ...
  textTheme:  const TextTheme().copyWith(
    displayLarge: const TextStyle().copyWith(fontSize: 60, fontWeight: FontWeight.w600,), // login
    ...
    headlineLarge: const TextStyle().copyWith(fontSize: 40, fontWeight: FontWeight.w600,),
